...
## Mídia de exercícios
A V6 usa um resolvedor de mídia em `js/services/media-resolver.js`. Os GIFs são carregados sob demanda de um CDN público, sem exigir download manual de cada exercício. O resolvedor consulta catálogos por grupo muscular e escolhe uma demonstração compatível com o movimento.

Para produção/comercialização, substituir essa fonte por uma biblioteca licenciada ou mídia própria. A fonte atual informa que os GIFs pertencem aos respectivos autores e não concede direitos de uso comercial por meio do repositório.
