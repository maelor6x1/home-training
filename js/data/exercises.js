...
const e=(id,name,body,target,equipment,level,type,base,sets,rest,goals,desc,media=null,extra={})=>({id,name,body,target,equipment,level,type,base,sets,rest,goals,desc,media,...extra});
